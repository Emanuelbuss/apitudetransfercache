...
/**
 * CurrencyPortfolioApi Class Doc Comment
 *
 * @category Class
 * @package  transfercache
 * @author   Swagger Codegen team
...
class CurrencyPortfolioApi
{
     ...
     * @return \transfercache\apitude_transfer_cache\CurrencyDTO
     */
    public function currency($fields, $language, $codes = null, $offset = '1', $limit = '1')
    {
        list($response) = $this->currencyWithHttpInfo($fields, $language, $codes, $offset, $limit);
        return $response;
    }
     ...
     * @throws \transfercache\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \transfercache\apitude_transfer_cache\CurrencyDTO, HTTP status code, HTTP response headers (array of strings)
     */
    public function currencyWithHttpInfo($fields, $language, $codes = null, $offset = '1', $limit = '1')
    {
        $returnType = '\transfercache\apitude_transfer_cache\CurrencyDTO';
        $request = $this->currencyRequest($fields, $language, $codes, $offset, $limit);
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\transfercache\apitude_transfer_cache\CurrencyDTO',
     ...
     */
    public function currencyAsync($fields, $language, $codes = null, $offset = '1', $limit = '1')
    {
        return $this->currencyAsyncWithHttpInfo($fields, $language, $codes, $offset, $limit)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function currencyAsyncWithHttpInfo($fields, $language, $codes = null, $offset = '1', $limit = '1')
    {
        $returnType = '\transfercache\apitude_transfer_cache\CurrencyDTO';
        $request = $this->currencyRequest($fields, $language, $codes, $offset, $limit);
     ...
     */
    protected function currencyRequest($fields, $language, $codes = null, $offset = '1', $limit = '1')
    {
        // verify the required parameter 'fields' is set
        if ($fields === null || (is_array($fields) && count($fields) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $fields when calling currency'
            );
        }
        // verify the required parameter 'language' is set
        if ($language === null || (is_array($language) && count($language) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $language when calling currency'
            );
        }

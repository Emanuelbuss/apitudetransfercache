...
/**
 * FieldErrorDTO Class Doc Comment
 *
 * @category Class
 * @package  transfercache
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class FieldErrorDTO implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'FieldErrorDTO';
...
'message' => 'getMessage'    ];
     ...
     * Sets code
     *
     * @param string $code The field error code
     *
     * @return $this
     */
     ...
     * Sets field
     *
     * @param string $field The name of the field with the error
     *
     * @return $this
     */
     ...
     * Sets message
     *
     * @param string $message The field error message
     *
     * @return $this
     */

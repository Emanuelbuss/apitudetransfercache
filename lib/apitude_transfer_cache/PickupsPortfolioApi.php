...
/**
 * PickupsPortfolioApi Class Doc Comment
 *
 * @category Class
 * @package  transfercache
 * @author   Swagger Codegen team
...
class PickupsPortfolioApi
{
     ...
     * @return \transfercache\apitude_transfer_cache\PickupDTO
     */
    public function pickup($fields, $language, $offset = '1', $limit = '1', $country_codes = null, $codes = null)
    {
        list($response) = $this->pickupWithHttpInfo($fields, $language, $offset, $limit, $country_codes, $codes);
        return $response;
    }

    /**
     * Operation pickupWithHttpInfo
     *
     * Pickup portfolio
     *
     * @param  string[] $fields Fields that will be informed in the response object. (required)
     ...
     * @throws \transfercache\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \transfercache\apitude_transfer_cache\PickupDTO, HTTP status code, HTTP response headers (array of strings)
     */
    public function pickupWithHttpInfo($fields, $language, $offset = '1', $limit = '1', $country_codes = null, $codes = null)
    {
        $returnType = '\transfercache\apitude_transfer_cache\PickupDTO';
        $request = $this->pickupRequest($fields, $language, $offset, $limit, $country_codes, $codes);
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\transfercache\apitude_transfer_cache\PickupDTO',
     ...
     */
    public function pickupAsync($fields, $language, $offset = '1', $limit = '1', $country_codes = null, $codes = null)
    {
        return $this->pickupAsyncWithHttpInfo($fields, $language, $offset, $limit, $country_codes, $codes)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation pickupAsyncWithHttpInfo
     *
     * Pickup portfolio
     *
     * @param  string[] $fields Fields that will be informed in the response object. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function pickupAsyncWithHttpInfo($fields, $language, $offset = '1', $limit = '1', $country_codes = null, $codes = null)
    {
        $returnType = '\transfercache\apitude_transfer_cache\PickupDTO';
        $request = $this->pickupRequest($fields, $language, $offset, $limit, $country_codes, $codes);
    ...
    /**
     * Create request for operation 'pickup'
     *
     * @param  string[] $fields Fields that will be informed in the response object. (required)
     * @param  string $language Language ISO code in which the response data will be translated into in the response object. (required)
     * @param  int $offset Used for pagination. Index of the item from which the list will be generated in the response object. (optional, default to 1)
     ...
     */
    protected function pickupRequest($fields, $language, $offset = '1', $limit = '1', $country_codes = null, $codes = null)
    {
        // verify the required parameter 'fields' is set
        if ($fields === null || (is_array($fields) && count($fields) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $fields when calling pickup'
            );
        }
        // verify the required parameter 'language' is set
        if ($language === null || (is_array($language) && count($language) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $language when calling pickup'
            );
        }
